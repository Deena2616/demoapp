...
final Map<String, dynamic> pageData = {
  ...
  'elements': [
    ...
    },
    {
      ...
      'videoUrl': '',
      'imageUrls': [
        'https://picsum.photos/id/962/800/400',
        'https://picsum.photos/id/884/800/400',
        'https://picsum.photos/id/455/800/400',
      ],
      'icon': 'star',
      'bold': false,
      'italic': false,
    ...
    },
    {
      ...
      'text': 'We use the right technology and strategies to build attractive, user-friendly eCommerce websites that improve customer experience, boost sales, and increase conversions.',
      'color': '#ff2c97ed',
      'size': 12.571428571428504,
      'padding': {
        'left': 8,
        'top': 8,
        'right': 7.738113403320283,
        'bottom': 8,
      },
      'margin': {
    ...
    },
    {
      ...
      'cards': [
        {
          'imageUrl': 'https://picsum.photos/id/784/200/300',
          'title': 'Title 1',
          'subtitle': 'Subtitle 1',
          'subscribeText': 'Subscribe',
        },
        {
          'imageUrl': 'https://picsum.photos/id/931/200/300',
          'title': 'Title 2',
          'subtitle': 'Subtitle 2',
          'subscribeText': 'Subscribe',
        },
    ...
    },
    {
      ...
      'cards': [
        {
          'imageUrl': 'https://picsum.photos/id/769/200/300',
          'title': 'Title 1',
          'subtitle': 'Subtitle 1',
          'subscribeText': 'Subscribe',
        },
        {
          'imageUrl': 'https://picsum.photos/id/637/200/300',
          'title': 'Title 2',
          'subtitle': 'Subtitle 2',
          'subscribeText': 'Subscribe',
        },
    ...
    },
    {
      ...
      'cards': [
        {
          'imageUrl': 'https://picsum.photos/id/935/200/300',
          'title': 'Title 1',
          'subtitle': 'Subtitle 1',
          'subscribeText': 'Subscribe',
        },
        {
          'imageUrl': 'https://picsum.photos/id/925/200/300',
          'title': 'Title 2',
          'subtitle': 'Subtitle 2',
          'subscribeText': 'Subscribe',
        },
    ...
    },
    {
      ...
      'fieldId': null,
      'fieldName': null,
      'imageUrl': 'https://picsum.photos/id/570/400/300',
      'fit': 'cover',
    },
    {
...
.copyWith(fontWeight: FontWeight.bold),
            ...
            child: Container(
              ...
              child: Opacity(
                ...
                child: ImageSliderWidget(
                  imageUrls: ['https://picsum.photos/id/962/800/400', 'https://picsum.photos/id/884/800/400', 'https://picsum.photos/id/455/800/400'],
                  height: 200,
                ),
              ),
            ),
            ...
            Padding(
            padding: EdgeInsets.fromLTRB(8, 8, 7.738113403320283, 8),
            child: Container(
              margin: EdgeInsets.fromLTRB(7.142857142857144, 4, 4, 4),
              width: double.infinity,
              decoration: BoxDecoration(
                color: Color(0x00000000),
                borderRadius: BorderRadius.circular(0),
              ...
              child: Opacity(
                opacity: 1,
                child: Text(
                  'We use the right technology and strategies to build attractive, user-friendly eCommerce websites that improve customer experience, boost sales, and increase conversions.',
                  style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 12.571428571428504,
  color: Color(0xff2c97ed),
  fontWeight: FontWeight.bold,
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              Image.network('https://picsum.photos/id/31/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/316/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/784/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 1', style: GoogleFonts.getFont(
  'Poppins',
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/931/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 2', style: GoogleFonts.getFont(
  'Poppins',
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/769/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 1', style: GoogleFonts.getFont(
  'Poppins',
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/637/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 2', style: GoogleFonts.getFont(
  'Poppins',
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/935/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 1', style: GoogleFonts.getFont(
  'Poppins',
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/925/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 2', style: GoogleFonts.getFont(
  'Poppins',
...
,
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: Image.network(
                  'https://picsum.photos/id/570/400/300',
                  fit: BoxFit.cover,
                ),
              ),
            ),
